...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEditLetter.setMinimumSize(QtCore.QSize(120, 26))
        ...
        self.gridLayout.addWidget(self.lineEditLetter, 0, 4, 1, 1) # строка, начало, что-то по высоте, длина
        ...
        self.gridLayout.addWidget(self.labelDataLetter, 0, 5, 1, 2)
        self.lineEditDateLetter = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEditDateLetter.setMinimumSize(QtCore.QSize(200, 26))
        ...
        self.gridLayout.addWidget(self.lineEditDateLetter, 0, 6, 1, 2)
        ...
        self.gridLayout.addLayout(self.SmallTableLayout, 0, 8, 4, 1)
        ...
        self.gridLayout.addWidget(self.lineEditCustomer, 1, 1, 1, 7)
        ...
        self.gridLayout.addWidget(self.lineEditContract, 2, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.labelCipher, 2, 5, 1, 1)
        ...
        self.lineEditCipher.setObjectName("lineEditCipher")
        self.gridLayout.addWidget(self.lineEditCipher, 2, 6, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEditProject, 3, 1, 1, 7)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_4, 4, 0, 1, 9)
